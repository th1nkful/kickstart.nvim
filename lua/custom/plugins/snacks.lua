return {
  {
    ...
    keys = {
      ...
      { '<leader>fa', function() Snacks.picker.files { hidden = true, ignored = true } end, desc = '[F]ind [A]ll Files' },
      { '<leader>fg', function() Snacks.picker.grep { hidden = true } end, desc = '[F]ind [G]rep' },
      { '<leader>fz', function() Snacks.picker.grep { hidden = true, ignored = true } end, desc = '[F]ind Gre[Z] (all files)' },
